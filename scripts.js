...
// ==========================================================================
// 1. SISTEMA DE PESTAÑAS (TABS) - OPTIMIZADO Y SEGURO PARA 7 BOTONES
// ==========================================================================
function switchTab(event, tabId) {
    // Evitamos problemas de propagación solo si el evento viene de un enlace directo
...
// ==========================================================================
// 3. VÍDEO FLOTANTE (ENTRADA "PC SECURE BOOT")
//    - Se reproduce al pasar el ratón por encima del marco.
//    - Al hacer clic, se amplía a pantalla completa (fill the screen up).
// ==========================================================================
...
// Reproducir al pasar el ratón por encima
video.addEventListener('mouseenter', function () {
var playPromise = video.play();
if (playPromise !== undefined) {
playPromise.catch(function () { /* Autoplay bloqueado: se ignora sin romper nada */ });
}
});

// Pausar al retirar el ratón
video.addEventListener('mouseleave', function () {
video.pause();
});

// Al hacer clic, ampliar a pantalla completa (con prefijos de compatibilidad)
